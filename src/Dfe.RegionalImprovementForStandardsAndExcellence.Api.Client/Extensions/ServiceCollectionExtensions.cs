...
using Dfe.RegionalImprovementForStandardsAndExcellence.Api.Client.Security;
using Dfe.RegionalImprovementForStandardsAndExcellence.Api.Client.Settings;
using Microsoft.Extensions.Configuration;
using Microsoft.Extensions.DependencyInjection;

namespace Dfe.RegionalImprovementForStandardsAndExcellence.Api.Client.Extensions
{
