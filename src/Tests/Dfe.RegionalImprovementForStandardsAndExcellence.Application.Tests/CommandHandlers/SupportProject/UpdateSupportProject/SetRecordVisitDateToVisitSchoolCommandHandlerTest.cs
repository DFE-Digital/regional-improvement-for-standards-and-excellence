...
{
    public class SetRecordVisitDateToVisitSchoolCommandHandlerTest
    {
        private readonly Mock<ISupportProjectRepository> _mockSupportProjectRepository;
        private readonly Domain.Entities.SupportProject.SupportProject _mockSupportProject;
        private readonly CancellationToken _cancellationToken;

        public SetRecordVisitDateToVisitSchoolCommandHandlerTest()
        {
        ...
        public async Task Handle_ValidCommand_UpdatesSupportProject()
        {
            ...
            var command = new SetRecordVisitDateToVisitSchoolCommand(_mockSupportProject.Id, schoolVisitDate);

            _mockSupportProjectRepository.Setup(repo => repo.FindAsync(It.IsAny<Expression<Func<Domain.Entities.SupportProject.SupportProject, bool>>>(), It.IsAny<CancellationToken>())).ReturnsAsync(_mockSupportProject);
            var handler = new SetRecordVisitDateToVisitSchoolCommandHandler(_mockSupportProjectRepository.Object);
        ...
        {
            // Arrange
            var command = new SetRecordVisitDateToVisitSchoolCommand(_mockSupportProject.Id, null);
        ...
        public async Task Handle_ProjectNotFound_ReturnsFalse()
        {
            ...
            var command = new SetRecordVisitDateToVisitSchoolCommand(
